...
class $$FruitsTableFilterComposer extends Composer<_$MyDatabase, $FruitsTable> {
  ...
  ColumnFilters<String> get famousArea => $composableBuilder(
      column: $table.famousArea, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get famousAreaEn => $composableBuilder(
      column: $table.famousAreaEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get season => $composableBuilder(
      column: $table.season, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get seasonEn => $composableBuilder(
      column: $table.seasonEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get famousBreed => $composableBuilder(
      column: $table.famousBreed, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get famousBreedEn => $composableBuilder(
      column: $table.famousBreedEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get sweetBreed => $composableBuilder(
      column: $table.sweetBreed, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get sweetBreedEn => $composableBuilder(
      column: $table.sweetBreedEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get seedlessVarieties => $composableBuilder(
      column: $table.seedlessVarieties,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get seedlessVarietiesEn => $composableBuilder(
      column: $table.seedlessVarietiesEn,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get priceRange => $composableBuilder(
      column: $table.priceRange, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get priceRangeEn => $composableBuilder(
      column: $table.priceRangeEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get nutrients => $composableBuilder(
      column: $table.nutrients, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get nutrientsEn => $composableBuilder(
      column: $table.nutrientsEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get nutrientEfficacy => $composableBuilder(
      column: $table.nutrientEfficacy,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get nutrientEfficacyEn => $composableBuilder(
      column: $table.nutrientEfficacyEn,
      builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get distinguish => $composableBuilder(
      column: $table.distinguish, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get distinguishEn => $composableBuilder(
      column: $table.distinguishEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get typeSpring => $composableBuilder(
      column: $table.typeSpring, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get typeSummer => $composableBuilder(
      column: $table.typeSummer, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get typeAutumn => $composableBuilder(
      column: $table.typeAutumn, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get typeWinter => $composableBuilder(
      column: $table.typeWinter, builder: (column) => ColumnFilters(column));
}

class $$FruitsTableOrderingComposer
    extends Composer<_$MyDatabase, $FruitsTable> {
  ...
  ColumnOrderings<String> get famousArea => $composableBuilder(
      column: $table.famousArea, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get famousAreaEn => $composableBuilder(
      column: $table.famousAreaEn,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get season => $composableBuilder(
      column: $table.season, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get seasonEn => $composableBuilder(
      column: $table.seasonEn, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get famousBreed => $composableBuilder(
      column: $table.famousBreed, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get famousBreedEn => $composableBuilder(
      column: $table.famousBreedEn,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get sweetBreed => $composableBuilder(
      column: $table.sweetBreed, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get sweetBreedEn => $composableBuilder(
      column: $table.sweetBreedEn,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get seedlessVarieties => $composableBuilder(
      column: $table.seedlessVarieties,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get seedlessVarietiesEn => $composableBuilder(
      column: $table.seedlessVarietiesEn,
      builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get priceRangeEn => $composableBuilder(
      column: $table.priceRangeEn,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get nutrients => $composableBuilder(
      column: $table.nutrients, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get nutrientsEn => $composableBuilder(
      column: $table.nutrientsEn, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get nutrientEfficacy => $composableBuilder(
      column: $table.nutrientEfficacy,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get nutrientEfficacyEn => $composableBuilder(
      column: $table.nutrientEfficacyEn,
      builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get distinguish => $composableBuilder(
      column: $table.distinguish, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get distinguishEn => $composableBuilder(
      column: $table.distinguishEn,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get typeSpring => $composableBuilder(
      column: $table.typeSpring, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get typeSummer => $composableBuilder(
      column: $table.typeSummer, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get typeAutumn => $composableBuilder(
      column: $table.typeAutumn, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get typeWinter => $composableBuilder(
      column: $table.typeWinter, builder: (column) => ColumnOrderings(column));
}
...
class $$FruitsTableAnnotationComposer
  ...
  GeneratedColumn<String> get famousArea => $composableBuilder(
      column: $table.famousArea, builder: (column) => column);

  GeneratedColumn<String> get famousAreaEn => $composableBuilder(
      column: $table.famousAreaEn, builder: (column) => column);

  GeneratedColumn<String> get season =>
      $composableBuilder(column: $table.season, builder: (column) => column);

  GeneratedColumn<String> get seasonEn =>
      $composableBuilder(column: $table.seasonEn, builder: (column) => column);

  GeneratedColumn<String> get famousBreed => $composableBuilder(
      column: $table.famousBreed, builder: (column) => column);

  GeneratedColumn<String> get famousBreedEn => $composableBuilder(
      column: $table.famousBreedEn, builder: (column) => column);

  GeneratedColumn<String> get sweetBreed => $composableBuilder(
      column: $table.sweetBreed, builder: (column) => column);

  GeneratedColumn<String> get sweetBreedEn => $composableBuilder(
      column: $table.sweetBreedEn, builder: (column) => column);

  GeneratedColumn<String> get seedlessVarieties => $composableBuilder(
      column: $table.seedlessVarieties, builder: (column) => column);

  GeneratedColumn<String> get seedlessVarietiesEn => $composableBuilder(
      column: $table.seedlessVarietiesEn, builder: (column) => column);

  GeneratedColumn<String> get priceRange => $composableBuilder(
      column: $table.priceRange, builder: (column) => column);

  GeneratedColumn<String> get priceRangeEn => $composableBuilder(
      column: $table.priceRangeEn, builder: (column) => column);

  GeneratedColumn<String> get nutrients =>
      $composableBuilder(column: $table.nutrients, builder: (column) => column);

  GeneratedColumn<String> get nutrientsEn => $composableBuilder(
      column: $table.nutrientsEn, builder: (column) => column);

  GeneratedColumn<String> get nutrientEfficacy => $composableBuilder(
      column: $table.nutrientEfficacy, builder: (column) => column);

  GeneratedColumn<String> get nutrientEfficacyEn => $composableBuilder(
      column: $table.nutrientEfficacyEn, builder: (column) => column);
  ...
  GeneratedColumn<String> get distinguish => $composableBuilder(
      column: $table.distinguish, builder: (column) => column);

  GeneratedColumn<String> get distinguishEn => $composableBuilder(
      column: $table.distinguishEn, builder: (column) => column);

  GeneratedColumn<bool> get typeSpring => $composableBuilder(
      column: $table.typeSpring, builder: (column) => column);

  GeneratedColumn<bool> get typeSummer => $composableBuilder(
      column: $table.typeSummer, builder: (column) => column);

  GeneratedColumn<bool> get typeAutumn => $composableBuilder(
      column: $table.typeAutumn, builder: (column) => column);

  GeneratedColumn<bool> get typeWinter => $composableBuilder(
      column: $table.typeWinter, builder: (column) => column);
}
...
class $$QuestionsTableFilterComposer
    extends Composer<_$MyDatabase, $QuestionsTable> {
  ...
  ColumnFilters<String> get answerEn => $composableBuilder(
      column: $table.answerEn, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice1 => $composableBuilder(
      column: $table.choice1, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice1En => $composableBuilder(
      column: $table.choice1En, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice2 => $composableBuilder(
      column: $table.choice2, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice2En => $composableBuilder(
      column: $table.choice2En, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice3 => $composableBuilder(
      column: $table.choice3, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get choice3En => $composableBuilder(
      column: $table.choice3En, builder: (column) => ColumnFilters(column));
...
class $$QuestionsTableOrderingComposer
  ...
  ColumnOrderings<String> get answerEn => $composableBuilder(
      column: $table.answerEn, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice1 => $composableBuilder(
      column: $table.choice1, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice1En => $composableBuilder(
      column: $table.choice1En, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice2 => $composableBuilder(
      column: $table.choice2, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice2En => $composableBuilder(
      column: $table.choice2En, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice3 => $composableBuilder(
      column: $table.choice3, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get choice3En => $composableBuilder(
      column: $table.choice3En, builder: (column) => ColumnOrderings(column));
...
class $$QuestionsTableAnnotationComposer
  ...
  GeneratedColumn<String> get choice1 =>
      $composableBuilder(column: $table.choice1, builder: (column) => column);

  GeneratedColumn<String> get choice1En =>
      $composableBuilder(column: $table.choice1En, builder: (column) => column);

  GeneratedColumn<String> get choice2 =>
      $composableBuilder(column: $table.choice2, builder: (column) => column);

  GeneratedColumn<String> get choice2En =>
      $composableBuilder(column: $table.choice2En, builder: (column) => column);

  GeneratedColumn<String> get choice3 =>
      $composableBuilder(column: $table.choice3, builder: (column) => column);

  GeneratedColumn<String> get choice3En =>
      $composableBuilder(column: $table.choice3En, builder: (column) => column);
