...
class $FruitsTable extends Fruits with TableInfo<$FruitsTable, Fruit> {
  ...
  late final GeneratedColumn<String> nutrients = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _image_file_nameMeta =
      const VerificationMeta('image_file_name');
  @override
  late final GeneratedColumn<String> image_file_name = GeneratedColumn<String>(
  ...
  VerificationContext validateIntegrity(Insertable<Fruit> instance,
    ...
    if (data.containsKey('image_file_name')) {
      context.handle(
          _image_file_nameMeta,
          image_file_name.isAcceptableOrUnknown(
              data['image_file_name']!, _image_file_nameMeta));
    } else if (isInserting) {
      context.missing(_image_file_nameMeta);
    }
    return context;
  }
  ...
  Fruit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Fruit(
      ...
      image_file_name: attachedDatabase.typeMapping.read(
...
class Fruit extends DataClass implements Insertable<Fruit> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['image_file_name'] = Variable<String>(image_file_name);
    return map;
  }
  ...
  factory Fruit.fromJson(Map<String, dynamic> json,
    ...
    return Fruit(
      ...
      image_file_name: serializer.fromJson<String>(json['image_file_name']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'image_file_name': serializer.toJson<String>(image_file_name),
    };
  }
  ...
  String toString() {
    return (StringBuffer('Fruit(')
          ...
          ..write('image_file_name: $image_file_name')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(id, name, famous_area, season, famous_breed,
      price_range, nutrients, image_file_name);
  @override
  bool operator ==(Object other) =>
      ...
      (other is Fruit &&
          ...
          other.image_file_name == this.image_file_name);
}
...
class FruitsCompanion extends UpdateCompanion<Fruit> {
  ...
  final Value<String> image_file_name;
  ...
  const FruitsCompanion({
    ...
    this.image_file_name = const Value.absent(),
  ...
  FruitsCompanion.insert({
    ...
    required String image_file_name,
    this.rowid = const Value.absent(),
  })  : id = Value(id),
        name = Value(name),
        famous_area = Value(famous_area),
  ...
  static Insertable<Fruit> custom({
    ...
    Expression<String>? image_file_name,
    ...
    return RawValuesInsertable({
      ...
      if (image_file_name != null) 'image_file_name': image_file_name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (image_file_name.present) {
      map['image_file_name'] = Variable<String>(image_file_name.value);
    }
    if (rowid.present) {
